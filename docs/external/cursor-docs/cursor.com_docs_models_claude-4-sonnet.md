<!-- Source: https://cursor.com/docs/models/claude-4-sonnet -->
<!-- Title: Claude 4 Sonnet | Cursor Docs -->

[Skip to main content](https://cursor.com/docs/models/claude-4-sonnet#main-content)
...
We recommend using [Claude 4.6 Sonnet](https://cursor.com/docs/models/claude-4-6-sonnet). It's the latest Sonnet with stronger capabilities at the same price.

## [Tools](https://cursor.com/docs/models/claude-4-sonnet\#tools)

Claude 4 Sonnet has access to all agent tools when used with Cursor including:
...
## [Pricing](https://cursor.com/docs/models/claude-4-sonnet\#pricing)

Cursor [plans](https://cursor.com/docs/models-and-pricing) include two usage pools. Claude 4 Sonnet draws from the **API** pool, which charges at the rates below. Individual plans include at least $20 of API usage each month (more on higher tiers). All prices are per million tokens.

| Name | Input | Cache Write | Cache Read | Output |
| --- | --- | --- | --- | --- |
| ![Anthropic](https://cursor.com/docs-static/images/providers/anthropic-dark.svg)![Anthropic](https://cursor.com/docs-static/images/providers/anthropic-light.svg)<br>[Claude 4 Sonnet](https://cursor.com/docs/models/claude-4-sonnet) | $3 | $3.75 | $0.3 | $15 |
