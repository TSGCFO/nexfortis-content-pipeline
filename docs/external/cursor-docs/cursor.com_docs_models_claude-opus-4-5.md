<!-- Source: https://cursor.com/docs/models/claude-opus-4-5 -->
<!-- Title: Claude 4.5 Opus | Cursor Docs -->

[Skip to main content](https://cursor.com/docs/models/claude-opus-4-5#main-content)
...
We recommend using [Claude 4.7 Opus](https://cursor.com/docs/models/claude-opus-4-7). It's the latest Opus with stronger reasoning and code quality.

## [Tools](https://cursor.com/docs/models/claude-opus-4-5\#tools)

Claude 4.5 Opus has access to all agent tools when used with Cursor including:
...
## [Pricing](https://cursor.com/docs/models/claude-opus-4-5\#pricing)

Cursor [plans](https://cursor.com/docs/models-and-pricing) include two usage pools. Claude 4.5 Opus draws from the **API** pool, which charges at the rates below. Individual plans include at least $20 of API usage each month (more on higher tiers). All prices are per million tokens.

| Name | Input | Cache Write | Cache Read | Output |
| --- | --- | --- | --- | --- |
| ![Anthropic](https://cursor.com/docs-static/images/providers/anthropic-dark.svg)![Anthropic](https://cursor.com/docs-static/images/providers/anthropic-light.svg)<br>[Claude 4.5 Opus](https://cursor.com/docs/models/claude-opus-4-5) | $5 | $6.25 | $0.5 | $25 |
