...
You can use the [Delete Agent API](https://cursor.com/docs/cloud-agent/api/endpoints#delete-an-agent-permanently) to explicitly delete a cloud agent's conversation history.
