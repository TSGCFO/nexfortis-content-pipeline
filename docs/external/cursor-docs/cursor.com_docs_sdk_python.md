...
<!-- Title: Cursor Python SDK | Cursor Documentation -->

[Skip to main content](https://cursor.com/docs/sdk/python#main-content)
...
## [Overview](https://cursor.com/docs/sdk/python\#overview)
...
| **Cloud (self-hosted)** | Same shape, but targets a [self-hosted pool](https://cursor.com/docs/cloud-agent/self-hosted-pool). | Same reasons as Cursor-hosted, plus code, secrets, and build artifacts must stay in your environment. |

Set the runtime by passing `local` or `cloud` to `Agent.create()`.

## [Authentication](https://cursor.com/docs/sdk/python\#authentication)
...
## [Usage and billing](https://cursor.com/docs/sdk/python\#usage-and-billing)
...
## [Core concepts](https://cursor.com/docs/sdk/python\#core-concepts)
...
## [Installation](https://cursor.com/docs/sdk/python\#installation)

```
uv pip install cursor-sdk
```

## [Quick start](https://cursor.com/docs/sdk/python\#quick-start)
...
[Stream events](https://cursor.com/docs/sdk/python#stream-events) shows how to extract assistant text, handle tool calls, and read run state. For a one-shot prompt (create, run, finish), see [`Agent.prompt()`](https://cursor.com/docs/sdk/python#agentprompt).

### [Cloud quick start](https://cursor.com/docs/sdk/python\#cloud-quick-start)
...
## [Async usage](https://cursor.com/docs/sdk/python\#async-usage)
...
## [Creating agents](https://cursor.com/docs/sdk/python\#creating-agents)
...
To target a [self-hosted pool](https://cursor.com/docs/cloud-agent/self-hosted-pool), set `env` on `CloudAgentOptions`:
...
### [Session environment variables](https://cursor.com/docs/sdk/python\#session-environment-variables)
...
### [Model parameters](https://cursor.com/docs/sdk/python\#model-parameters)

Use `ModelSelection.params` to pass per-model options such as reasoning effort or max mode. Parameter IDs and values vary by model. Use [`Cursor.models.list()`](https://cursor.com/docs/sdk/python#the-cursor-namespace) to discover supported parameters and preset variants for your account.
...
Use [`Cursor.models.list()`](https://cursor.com/docs/sdk/python#the-cursor-namespace) to discover the parameter IDs and preset variants for a given model.

### [Raw dictionaries](https://cursor.com/docs/sdk/python\#raw-dictionaries)
...
## [Agent](https://cursor.com/docs/sdk/python\#agent)
...
### [Agent.prompt()](https://cursor.com/docs/sdk/python\#agentprompt)
...
## [CursorClient](https://cursor.com/docs/sdk/python\#cursorclient)
...
### [Resources](https://cursor.com/docs/sdk/python\#resources)
...
### [Custom HTTP clients](https://cursor.com/docs/sdk/python\#custom-http-clients)
...
### [Connecting to a running bridge](https://cursor.com/docs/sdk/python\#connecting-to-a-running-bridge)
...
### [Configuring timeouts and retries](https://cursor.com/docs/sdk/python\#configuring-timeouts-and-retries)
...
## [Sending messages](https://cursor.com/docs/sdk/python\#sending-messages)
...
### [Run](https://cursor.com/docs/sdk/python\#run)
...
### [Streaming](https://cursor.com/docs/sdk/python\#streaming)
...
### [Waiting without streaming](https://cursor.com/docs/sdk/python\#waiting-without-streaming)
...
### [Reading text output](https://cursor.com/docs/sdk/python\#reading-text-output)
...
### [Cancelling a run](https://cursor.com/docs/sdk/python\#cancelling-a-run)
...
### [Reading run state](https://cursor.com/docs/sdk/python\#reading-run-state)
...
### [Per-run model override](https://cursor.com/docs/sdk/python\#per-run-model-override)
...
### [Conversation mode](https://cursor.com/docs/sdk/python\#conversation-mode)
...
### [Streaming raw deltas](https://cursor.com/docs/sdk/python\#streaming-raw-deltas)
...
### [SendOptions](https://cursor.com/docs/sdk/python\#sendoptions)
...
The next three sections are detailed reference for `SDKMessage`, `InteractionUpdate`, and `ConversationTurn`. Skim or skip on a first read; [Resuming agents](https://cursor.com/docs/sdk/python#resuming-agents) picks up the narrative.

## [Stream events](https://cursor.com/docs/sdk/python\#stream-events)
...
## [Interaction updates](https://cursor.com/docs/sdk/python\#interaction-updates)
...
## [Conversation types](https://cursor.com/docs/sdk/python\#conversation-types)
...
`run.conversation()` from `on_step` callbacks fires per `ConversationStep`, not per turn. Tool-call conversation steps carry a `Mapping[str, Any]` payload. Treat tool-call payload details as untyped data; see the [stability note](https://cursor.com/docs/sdk/python#stream-events) under Stream events.

## [Resuming agents](https://cursor.com/docs/sdk/python\#resuming-agents)
...
## [Inspecting agents and runs](https://cursor.com/docs/sdk/python\#inspecting-agents-and-runs)
...
### [SDKAgentInfo](https://cursor.com/docs/sdk/python\#sdkagentinfo)
...
### [Cloud agent lifecycle](https://cursor.com/docs/sdk/python\#cloud-agent-lifecycle)
...
## [The Cursor namespace](https://cursor.com/docs/sdk/python\#the-cursor-namespace)
...
## [MCP servers](https://cursor.com/docs/sdk/python\#mcp-servers)
...
### [What gets loaded](https://cursor.com/docs/sdk/python\#what-gets-loaded)
...
### [Cloud](https://cursor.com/docs/sdk/python\#cloud)
...
## [Subagents](https://cursor.com/docs/sdk/python\#subagents)
...
## [Hooks](https://cursor.com/docs/sdk/python\#hooks)
...
## [Artifacts](https://cursor.com/docs/sdk/python\#artifacts)
...
## [Resource management](https://cursor.com/docs/sdk/python\#resource-management)
...
## [Configuration reference](https://cursor.com/docs/sdk/python\#configuration-reference)
...
### [AgentOptions](https://cursor.com/docs/sdk/python\#agentoptions)

| Property | Type | Default | Description |
| --- | --- | --- | --- |
| `model` | `str | ModelSelection | Mapping[str, Any]` | Required for local; cloud falls back to the server-resolved default | Model to use. See [`ModelSelection`](https://cursor.com/docs/sdk/python#modelselection). |
...
| `mode` | `"agent" | "plan"` | `"agent"` | Initial conversation mode for the agent's first run. See [Conversation mode](https://cursor.com/docs/sdk/python#conversation-mode). |

### [LocalAgentOptions](https://cursor.com/docs/sdk/python\#localagentoptions)
...
### [CloudAgentOptions](https://cursor.com/docs/sdk/python\#cloudagentoptions)

| Property | Type | Default | Description |
| --- | --- | --- | --- |
| `env` | `CloudEnvironment | Mapping[str, Any]` | `{ type: "cloud" }` | Execution environment. `cloud` uses Cursor-hosted VMs; `pool` and `machine` target a [self-hosted pool](https://cursor.com/docs/cloud-agent/self-hosted-pool). |
...
### [AgentDefinition](https://cursor.com/docs/sdk/python\#agentdefinition)

| Property | Type | Default | Description |
| --- | --- | --- | --- |
| `description` | `str` | _required_ | When to use this subagent. Shown to the parent agent so it knows when to spawn. |
| `prompt` | `str` | _required_ | System prompt for the subagent. |
...
### [ModelSelection](https://cursor.com/docs/sdk/python\#modelselection)
...
### [McpServerConfig](https://cursor.com/docs/sdk/python\#mcpserverconfig)
...
### [UserMessage](https://cursor.com/docs/sdk/python\#usermessage)
...
### [SDKImage](https://cursor.com/docs/sdk/python\#sdkimage)
...
### [SettingSource](https://cursor.com/docs/sdk/python\#settingsource)
...
### [ListResult](https://cursor.com/docs/sdk/python\#listresult)
...
## [Errors](https://cursor.com/docs/sdk/python\#errors)
...
### [Retrying with backoff](https://cursor.com/docs/sdk/python\#retrying-with-backoff)
...
### [IntegrationNotConnectedError](https://cursor.com/docs/sdk/python\#integrationnotconnectederror)
...
### [AgentBusyError](https://cursor.com/docs/sdk/python\#agentbusyerror)
...
### [UnsupportedRunOperationError](https://cursor.com/docs/sdk/python\#unsupportedrunoperationerror)
...
## [Troubleshooting](https://cursor.com/docs/sdk/python\#troubleshooting)
...
## [Known limitations](https://cursor.com/docs/sdk/python\#known-limitations)
