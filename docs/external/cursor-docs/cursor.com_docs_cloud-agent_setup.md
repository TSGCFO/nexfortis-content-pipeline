...
## [What is a cloud agent environment?](https://cursor.com/docs/cloud-agent/setup\#what-is-a-cloud-agent-environment)
...
![Cloud agent development environment architecture](https://cursor.com/docs-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2Fcloud-agents-architecture-light.png&w=1920&q=75)![Cloud agent development environment architecture](https://cursor.com/docs-static/_next/image?url=https%3A%2F%2Fptht05hbb1ssoooe.public.blob.vercel-storage.com%2Fassets%2Fblog%2Fcloud-agents-architecture-dark.png&w=1920&q=75)

## [Why does environment configuration matter?](https://cursor.com/docs/cloud-agent/setup\#why-does-environment-configuration-matter)
...
## [Environment setup options](https://cursor.com/docs/cloud-agent/setup\#environment-setup-options)
...
### [Multi-repo environments](https://cursor.com/docs/cloud-agent/setup\#multi-repo-environments)
...
If your repo needs Docker or Tailscale, see [Running Docker](https://cursor.com/docs/cloud-agent/setup#running-docker) and [Running Tailscale](https://cursor.com/docs/cloud-agent/setup#running-tailscale) below.
...
### [Cursor-configured Dockerfiles (private beta)](https://cursor.com/docs/cloud-agent/setup\#cursor-configured-dockerfiles-private-beta)
...
### [Environment configuration recovery](https://cursor.com/docs/cloud-agent/setup\#environment-configuration-recovery)
...
For more about the different types of secrets, see our [Secrets documentation](https://cursor.com/docs/cloud-agent/security-network#secret-protection).

### [Environment-scoped secrets](https://cursor.com/docs/cloud-agent/setup\#environment-scoped-secrets)
...
### [Sign-in credentials and 2FA](https://cursor.com/docs/cloud-agent/setup\#sign-in-credentials-and-2fa)
...
### [Using AWS IAM Roles](https://cursor.com/docs/cloud-agent/setup\#using-aws-iam-roles)
...
## [Configuration in code with environment.json](https://cursor.com/docs/cloud-agent/setup\#configuration-in-code-with-environmentjson)
...
## [Running Docker](https://cursor.com/docs/cloud-agent/setup\#running-docker)
...
## [Running Tailscale](https://cursor.com/docs/cloud-agent/setup\#running-tailscale)
