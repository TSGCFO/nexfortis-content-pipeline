...
![Tool confirmation prompt](https://cursor.com/docs-static/_next/image?url=%2Fdocs-static%2Fimages%2Fcontext%2Fmcp%2Ftool-confirm.png&w=1920&q=75&dpl=dpl_7UAjkDundnDt84UyVxZXdo4fDHt5)

#### [Auto-run](https://cursor.com/docs/mcp\#auto-run)

Enable auto-run for Agent to use MCP tools without asking. Works like terminal commands. Read more about auto-run modes [here](https://cursor.com/docs/agent/tools/terminal#auto-run-mode).
...
![MCP tool call result](https://cursor.com/docs-static/_next/image?url=%2Fdocs-static%2Fimages%2Fcontext%2Fmcp%2Ftool-call.png&w=1920&q=75&dpl=dpl_7UAjkDundnDt84UyVxZXdo4fDHt5)
