...
## [MCP servers](https://cursor.com/docs/cli/acp\#mcp-servers)
...
### [`cursor/ask_question`](https://cursor.com/docs/cli/acp\#cursorask_question)
...
### [`cursor/create_plan`](https://cursor.com/docs/cli/acp\#cursorcreate_plan)
...
### [`cursor/update_todos`](https://cursor.com/docs/cli/acp\#cursorupdate_todos)
...
### [`cursor/task`](https://cursor.com/docs/cli/acp\#cursortask)
...
### [`cursor/generate_image`](https://cursor.com/docs/cli/acp\#cursorgenerate_image)
