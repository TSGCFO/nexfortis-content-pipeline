...
<!-- Title: Slash commands | Cursor Docs -->
...
| `/quit` | Exit |
| `/setup-terminal` | Auto-configure terminal keybindings (see [Terminal Setup](https://cursor.com/docs/cli/reference/terminal-setup)) |
