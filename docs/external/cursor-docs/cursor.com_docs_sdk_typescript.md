...
<!-- Title: Cursor TypeScript SDK | Cursor Documentation -->

[Skip to main content](https://cursor.com/docs/sdk/typescript#main-content)
...
## [Overview](https://cursor.com/docs/sdk/typescript\#overview)
...
| **Cloud (self-hosted)** | Same shape, but you run the VMs via a [self-hosted pool](https://cursor.com/docs/cloud-agent/self-hosted-pool). | Same reasons as Cursor-hosted, plus code, secrets, and build artifacts must stay in your environment. |
...
For the REST API, see the [Cloud Agents API](https://cursor.com/docs/cloud-agent/api/endpoints).
...
- **Service account API key** from [Team settings](https://cursor.com/dashboard/team-settings). See [Service accounts](https://cursor.com/docs/account/enterprise/service-accounts)

```
export CURSOR_API_KEY="your-key"
```

## [Usage and billing](https://cursor.com/docs/sdk/typescript\#usage-and-billing)
...
## [Core concepts](https://cursor.com/docs/sdk/typescript\#core-concepts)
...
## [Installation](https://cursor.com/docs/sdk/typescript\#installation)
...
### [Runtime support](https://cursor.com/docs/sdk/typescript\#runtime-support)
...
## [Quick start](https://cursor.com/docs/sdk/typescript\#quick-start)

The fastest way in: a local agent against your current working tree, streaming events as they come in. Cloud setup is in [Creating agents](https://cursor.com/docs/sdk/typescript#creating-agents) below.
...
Each event is a discriminated `SDKMessage`. [Streaming](https://cursor.com/docs/sdk/typescript#streaming) shows how to extract assistant text, handle tool calls, and clean up with `await using`. For a one-shot prompt (create, run, dispose), see [Agent.prompt()](https://cursor.com/docs/sdk/typescript#agentprompt).
...
gate tool calls, configure [hooks](https://cursor.com/docs/sdk/typescript#hooks) (such as `beforeShellExecution` or
`preToolUse`) or run with [`local.sandboxOptions.enabled:   true`](https://cursor.com/docs/sdk/typescript#sandbox-options).

## [Creating agents](https://cursor.com/docs/sdk/typescript\#creating-agents)
...
### [Session environment variables](https://cursor.com/docs/sdk/typescript\#session-environment-variables)
...
### [Model parameters](https://cursor.com/docs/sdk/typescript\#model-parameters)

Use `model.params` to pass per-model options such as reasoning effort. Parameter ids and values vary by model. Use [`Cursor.models.list()`](https://cursor.com/docs/sdk/typescript#cursormodelslist) to discover supported parameters and preset variants for your account.

When a selected model requires [Max Mode](https://cursor.com/help/ai-features/max-mode), Cursor enables it automatically for the SDK request.
...
### [SDKAgent](https://cursor.com/docs/sdk/typescript\#sdkagent)
...
### [Agent.prompt()](https://cursor.com/docs/sdk/typescript\#agentprompt)
...
## [Sending messages](https://cursor.com/docs/sdk/typescript\#sending-messages)
...
### [Run](https://cursor.com/docs/sdk/typescript\#run)
...
### [Streaming](https://cursor.com/docs/sdk/typescript\#streaming)
...
### [Waiting without streaming](https://cursor.com/docs/sdk/typescript\#waiting-without-streaming)
...
### [Cancelling a run](https://cursor.com/docs/sdk/typescript\#cancelling-a-run)
...
### [Reading run state](https://cursor.com/docs/sdk/typescript\#reading-run-state)
...
### [Per-run model override](https://cursor.com/docs/sdk/typescript\#per-run-model-override)
...
### [Conversation mode](https://cursor.com/docs/sdk/typescript\#conversation-mode)

Pass `mode: "plan"` or `mode: "agent"` to control whether a run explores and plans first or implements changes directly. See [Plan mode](https://cursor.com/help/ai-features/plan-mode) for what plan mode does in the product.
...
### [Streaming raw deltas](https://cursor.com/docs/sdk/typescript\#streaming-raw-deltas)
...
### [Per-send options](https://cursor.com/docs/sdk/typescript\#per-send-options)
...
The next three sections are detailed reference for `SDKMessage`, `InteractionUpdate`, and `ConversationTurn`. Skim or skip on a first read; [Resuming agents](https://cursor.com/docs/sdk/typescript#resuming-agents) picks up the narrative.

## [Stream events](https://cursor.com/docs/sdk/typescript\#stream-events)
...
### [Message types](https://cursor.com/docs/sdk/typescript\#message-types)
...
## [Interaction updates](https://cursor.com/docs/sdk/typescript\#interaction-updates)
...
### [Update types](https://cursor.com/docs/sdk/typescript\#update-types)
...
## [Conversation types](https://cursor.com/docs/sdk/typescript\#conversation-types)
...
`ToolCall` is a discriminated union over every built-in tool (shell, edit, read, write, glob, grep, ls, semSearch, mcp, task, and others). Its shape is internal-facing; see the [stability note](https://cursor.com/docs/sdk/typescript#stream-events) under Stream events.

## [Resuming agents](https://cursor.com/docs/sdk/typescript\#resuming-agents)
...
## [Inspecting agents and runs](https://cursor.com/docs/sdk/typescript\#inspecting-agents-and-runs)

List, fetch, and reload past agents. List endpoints return `{ items, nextCursor? }` for cursor-based pagination.

### [Agent.list()](https://cursor.com/docs/sdk/typescript\#agentlist)
...
### [Agent.get()](https://cursor.com/docs/sdk/typescript\#agentget)
...
### [Agent.listRuns()](https://cursor.com/docs/sdk/typescript\#agentlistruns)
...
### [Agent.getRun()](https://cursor.com/docs/sdk/typescript\#agentgetrun)
...
### [Cloud agent lifecycle](https://cursor.com/docs/sdk/typescript\#cloud-agent-lifecycle)
...
### [SDKAgentInfo](https://cursor.com/docs/sdk/typescript\#sdkagentinfo)
...
## [The Cursor namespace](https://cursor.com/docs/sdk/typescript\#the-cursor-namespace)

Account-level and catalog reads. All methods take an optional `{ apiKey }` and otherwise fall back to `CURSOR_API_KEY`.

### [Cursor.me()](https://cursor.com/docs/sdk/typescript\#cursorme)
...
### [Cursor.models.list()](https://cursor.com/docs/sdk/typescript\#cursormodelslist)
...
#### [Best practices](https://cursor.com/docs/sdk/typescript\#best-practices)
...
### [Cursor.repositories.list()](https://cursor.com/docs/sdk/typescript\#cursorrepositorieslist)
...
## [Configuration sources at a glance](https://cursor.com/docs/sdk/typescript\#configuration-sources-at-a-glance)
...
| **Hooks** | None — file-based only | `.cursor/hooks.json` (\+ scripts) | `~/.cursor/hooks.json` | Cloud runs project hooks. On Enterprise plans, also team and enterprise-managed hooks. | File-based; project layered with user / team / enterprise per [Hooks](https://cursor.com/docs/hooks) |
...
## [MCP servers](https://cursor.com/docs/sdk/typescript\#mcp-servers)
...
### [What gets loaded](https://cursor.com/docs/sdk/typescript\#what-gets-loaded)
...
### [Local](https://cursor.com/docs/sdk/typescript\#local)
...
### [Cloud](https://cursor.com/docs/sdk/typescript\#cloud)
...
See [MCP](https://cursor.com/docs/mcp) for the full config format and [Cloud Agent capabilities](https://cursor.com/docs/cloud-agent/capabilities#mcp-tools) for cloud-specific behavior.

## [Subagents](https://cursor.com/docs/sdk/typescript\#subagents)
...
## [Hooks](https://cursor.com/docs/sdk/typescript\#hooks)
...
See [Hooks](https://cursor.com/docs/hooks) for the configuration format and [Cloud Agents hooks support](https://cursor.com/docs/cloud-agent#hooks-support) for cloud behavior.

## [Sandbox options](https://cursor.com/docs/sdk/typescript\#sandbox-options)
...
## [Artifacts](https://cursor.com/docs/sdk/typescript\#artifacts)
...
## [Resource management](https://cursor.com/docs/sdk/typescript\#resource-management)
...
## [Agent lifecycle](https://cursor.com/docs/sdk/typescript\#agent-lifecycle)

### [Reattach to an existing agent](https://cursor.com/docs/sdk/typescript\#reattach-to-an-existing-agent)
...
### [Conversation context](https://cursor.com/docs/sdk/typescript\#conversation-context)
...
### [Dispatcher pattern](https://cursor.com/docs/sdk/typescript\#dispatcher-pattern)
...
## [Configuration reference](https://cursor.com/docs/sdk/typescript\#configuration-reference)

### [AgentOptions](https://cursor.com/docs/sdk/typescript\#agentoptions)

| Property | Type | Default | Description |
| --- | --- | --- | --- |
| `model` | `ModelSelection` | Required for local; cloud falls back to the server-resolved default | Model to use. See [`ModelSelection`](https://cursor.com/docs/sdk/typescript#modelselection). |
...
| `mode` | `"agent" | "plan"` | `"agent"` | Initial conversation mode for the agent's first run. See [Conversation mode](https://cursor.com/docs/sdk/typescript#conversation-mode). |

### [CloudOptions](https://cursor.com/docs/sdk/typescript\#cloudoptions)

| Property | Type | Default | Description |
| --- | --- | --- | --- |
| `env` | `{ type: "cloud"; name?: string } | { type: "pool"; name?: string } | { type: "machine"; name?: string }` | `{ type: "cloud" }` | Execution environment target. `cloud` uses Cursor-hosted VMs; set `name` to use a saved Cursor-hosted environment. `pool` routes to a [Self-Hosted Pool](https://cursor.com/docs/cloud-agent/self-hosted-pool); `machine` routes to a specific [My Machines](https://cursor.com/docs/cloud-agent/my-machines) worker. Omit `repos` and leave `env` at the default for a no-repo agent with an empty workspace. Named Cursor-hosted environments and explicit `repos` are mutually exclusive. |
...
### [AgentDefinition](https://cursor.com/docs/sdk/typescript\#agentdefinition)

| Property | Type | Default | Description |
| --- | --- | --- | --- |
| `description` | `string` | _required_ | When to use this subagent. Shown to the parent agent so it knows when to spawn. |
| `prompt` | `string` | _required_ | System prompt for the subagent. |
...
### [ModelSelection](https://cursor.com/docs/sdk/typescript\#modelselection)
...
`id` is the model identifier (for example, `"composer-2.5"`). `params` carries per-model parameters such as reasoning effort. Use [`Cursor.models.list()`](https://cursor.com/docs/sdk/typescript#cursormodelslist) to discover valid ids, parameter definitions, and preset variants for your account.

### [McpServerConfig](https://cursor.com/docs/sdk/typescript\#mcpserverconfig)
...
### [SDKUserMessage](https://cursor.com/docs/sdk/typescript\#sdkusermessage)
...
### [SDKImage](https://cursor.com/docs/sdk/typescript\#sdkimage)
...
### [SettingSource](https://cursor.com/docs/sdk/typescript\#settingsource)
...
### [ListResult](https://cursor.com/docs/sdk/typescript\#listresult)
...
## [Errors](https://cursor.com/docs/sdk/typescript\#errors)
...
| --- | --- | --- | --- |
| `AuthenticationError` | "Invalid API key" | Missing or wrong `CURSOR_API_KEY`, expired token, or admin disabled the key. | Generate a new key from [Integrations](https://cursor.com/dashboard/integrations) (user) or [Team settings](https://cursor.com/dashboard/team-settings) (service account). Confirm the key has permission for the operation. |
| `RateLimitError` | "Rate limit exceeded" or "Usage limit exceeded" | Burst limit or monthly usage cap. | Back off using exponential delay (the SDK reports `isRetryable: true` for transient cases). For monthly cap, raise the plan's [usage limit](https://cursor.com/docs/account/usage). |
...
### [IntegrationNotConnectedError](https://cursor.com/docs/sdk/typescript\#integrationnotconnectederror)
...
### [UnsupportedRunOperationError](https://cursor.com/docs/sdk/typescript\#unsupportedrunoperationerror)
...
## [Known limitations](https://cursor.com/docs/sdk/typescript\#known-limitations)
