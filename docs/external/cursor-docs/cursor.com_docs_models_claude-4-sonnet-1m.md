<!-- Source: https://cursor.com/docs/models/claude-4-sonnet-1m -->
<!-- Title: Claude 4 Sonnet 1M | Cursor Docs -->

[Skip to main content](https://cursor.com/docs/models/claude-4-sonnet-1m#main-content)
...
We recommend using [Claude 4.6 Sonnet](https://cursor.com/docs/models/claude-4-6-sonnet), which also supports up to 1M context in Max Mode.

## [Tools](https://cursor.com/docs/models/claude-4-sonnet-1m\#tools)

Claude 4 Sonnet 1M has access to all agent tools when used with Cursor including:
...
## [Pricing](https://cursor.com/docs/models/claude-4-sonnet-1m\#pricing)

Cursor [plans](https://cursor.com/docs/models-and-pricing) include two usage pools. Claude 4 Sonnet 1M draws from the **API** pool, which charges at the rates below. Individual plans include at least $20 of API usage each month (more on higher tiers). All prices are per million tokens.

| Name | Input | Cache Write | Cache Read | Output |
| --- | --- | --- | --- | --- |
| ![Anthropic](https://cursor.com/docs-static/images/providers/anthropic-dark.svg)![Anthropic](https://cursor.com/docs-static/images/providers/anthropic-light.svg)<br>[Claude 4 Sonnet 1M](https://cursor.com/docs/models/claude-4-sonnet-1m) | $6 | $7.5 | $0.6 | $22.5 |
