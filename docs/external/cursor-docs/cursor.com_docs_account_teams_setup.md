...
<!-- Title: Get Started with Teams | Cursor Docs -->

[Skip to main content](https://cursor.com/docs/account/teams/setup#main-content)
...
## [Cursor for Teams](https://cursor.com/docs/account/teams/setup\#cursor-for-teams)
...
## [Creating a Team](https://cursor.com/docs/account/teams/setup\#creating-a-team)
...
2. **For existing users**: Go to your [dashboard](https://cursor.com/docs/account/teams/dashboard) and click "Upgrade to Teams"
...
Enable [SSO](https://cursor.com/docs/account/teams/sso) for security and automated onboarding.

## [FAQ](https://cursor.com/docs/account/teams/setup\#faq)
...
Set yourself as an [Unpaid Admin](https://cursor.com/docs/account/teams/members) to manage without a license.
