...
<!-- Title: Analytics API | Cursor Docs -->
...
- The Analytics API uses [Basic Authentication](https://cursor.com/docs/api#basic-authentication). You must generate an admin-scoped API key (with `admin:*` scope) from your [team settings page](https://cursor.com/settings).
...
### [Skills Adoption](https://cursor.com/docs/account/teams/analytics-api\#skills-adoption)
...
### [Conversation Insights](https://cursor.com/docs/account/teams/analytics-api\#conversation-insights)
...
For user-level filtering, use the shared `users` query parameter described in [Team-Level Endpoints](https://cursor.com/docs/account/teams/analytics-api#team-level-endpoints). SCIM group filtering is available in the dashboard UI only and isn't supported in the Analytics API.
...
#### [Parameters](https://cursor.com/docs/account/teams/analytics-api\#parameters-23)

`startDate`string

Start date for the analytics period (default: 7 days ago). See [Date Formats](https://cursor.com/docs/account/teams/analytics-api#date-formats)

`endDate`string

End date for the analytics period (default: today). See [Date Formats](https://cursor.com/docs/account/teams/analytics-api#date-formats)
...
### [Skills Adoption By User](https://cursor.com/docs/account/teams/analytics-api\#skills-adoption-by-user)

GET`/analytics/by-user/skills`

Get Skills adoption metrics organized by individual users with pagination support.

#### [Parameters](https://cursor.com/docs/account/teams/analytics-api\#parameters-21)
...
#### [Parameters](https://cursor.com/docs/account/teams/analytics-api\#parameters-22)
